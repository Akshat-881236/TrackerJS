  /* MIT License – Akshat Network Hub
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const POLICY_SETTINGS = {
    ...
    policyVersion: "1.0.0",       // 🔥 CHANGE ON POLICY UPDATE
  ...
  const project_db = [
    {
      ...
      feedbackUrl: `https://akshat-881236.github.io/Portfolio-881236/feedback.htm?title=Global%20Navbar&description=A%20global%20navbar%20injected%20by%20TrackerJS&url=${encodeURIComponent(window.location.href)}`
    ...
    band.innerHTML = `
      <div class="anh-card">
        <div class="anh-text-group">
          ...
          <a href="${project.feedbackUrl}" class="anh-btn secondary" target="_blank" rel="noopener">Feedback</a>
        </div>
        <div class="anh-actions">
          ${
            POLICY_SETTINGS.enforce
              ? ""
              : `<button class="anh-close" aria-label="Dismiss policy banner">✖</button>`
          }
        </div>
      </div>
    `;
